...
- [#29](https://github.com/germ-network/swift-raae/pull/29) [`5ffcedb`](https://github.com/germ-network/swift-raae/commit/5ffcedb8aa062d8838ee56c9bf8f20aadab88b17) Thanks [@germ-mark](https://github.com/germ-mark)! - Remove the stale `RAAE.version` constant.
...
- [#27](https://github.com/germ-network/swift-raae/pull/27) [`ff42c3d`](https://github.com/germ-network/swift-raae/commit/ff42c3dd1c28536b4f0a456acedf5547a72bc459) Thanks [@germ-mark](https://github.com/germ-mark)! - Adopt swift-crypto 5.0 and `swift-secret-bytes` 0.5, moving the remaining secret
  ...
  **Three breaking API changes.**
  ...
  - **`Segment.derivedNonce(nonceBase:)` takes a `SecretBytes`, not `[UInt8]`.** The
    ...
    is a _nonce_, not a key — it is never passed to a key-taking API — so it is held in
    `SecretBytes` custody rather than `SymmetricKey`, exactly as the accumulator is. The
    _returned_ nonce stays `[UInt8]`: AEAD security requires nonce _uniqueness_, not secrecy,
...
- [#23](https://github.com/germ-network/swift-raae/pull/23) [`15c13b5`](https://github.com/germ-network/swift-raae/commit/15c13b540916d8a556d0ce5ece9fbbbb18758723) Thanks [@germ-mark](https://github.com/germ-mark)! - Add `SEALEnvelope`, a self-describing wrapper that carries the cipher suite alongside a
...
- [#19](https://github.com/germ-network/swift-raae/pull/19) [`07167e6`](https://github.com/germ-network/swift-raae/commit/07167e61f7a5c52c089255c7349a062c2f6adea0) Thanks [@germ-mark](https://github.com/germ-mark)! - Resync the conformance target to the published draft-sullivan-cfrg-raae-02 (2026-07-13).
...
- [#20](https://github.com/germ-network/swift-raae/pull/20) [`6900301`](https://github.com/germ-network/swift-raae/commit/6900301055d049e890cbe238e1f06ce26e443880) Thanks [@germ-mark](https://github.com/germ-mark)! - Ship the reduced immutable linear layout (§4.11.4) as the adopter API, so
