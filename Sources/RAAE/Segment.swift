...
/// Per-segment encryption/decryption (draft §4.4.2 AAD + §4.8). Random nonce mode is
/// implemented here; derived mode (which binds index/is_final into the nonce) lands in
/// Stage 2b.
enum Segment {
	...
	static func aadRandomMode(
		...
		// longHash is irrelevant; route it through the schedule's KDF for consistency.
